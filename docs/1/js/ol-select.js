...
class OlSelect extends HTMLElement {
    ...
    connectedCallback() {
        ...
        console.log(this.#makeStyle())
        this._shadowRoot.appendChild(this.#makeStyle())
        this._shadowRoot.appendChild(this.#makeUl())
        //this._shadowRoot.innerHTML = `<style>ul{list-style:none;padding:0;}</style>`
    }
    ...
    #makeUl() { return this.#makeEl('ul', {}, this.#makeEl('slot', {name:'item'})) }
    /*
    #makeUl() {
    ...
    */
    ...
    #makeStyle() { return this.#makeEl('style', null, `ul{list-style:none;padding:0;}`) }
//    #makeStyle() {
//        const style = this.#makeEl('style', null, `ul{list-style:none;padding:0;}`)
//        style.textContent = `ul{list-style:none;padding:0;}`
//        retur
//    }
}
